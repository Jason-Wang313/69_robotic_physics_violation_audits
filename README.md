...
This repository contains a hardened, honest workshop-only robotics paper draft for `robotic_physics_violation_audits`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/69.pdf`
