...
\usepackage{url}
\usepackage{booktabs}
\title{Robotic Physics Violation Audits: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about foundation-model evaluation for embodied agents. The original research bet was: Audit robot policies by the physics violations they silently tolerate. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\item Physics-informed embodied intelligence in the foundation model era: Advancing robot manipulation for smart manufacturing (2026)
\item AGENTSAFE: Benchmarking the Safety of Embodied Agents on Hazardous Instructions (2025)
\item OmniEEG-Bench: A Standardized Evaluation Benchmark for EEG Foundation Models (2026)
